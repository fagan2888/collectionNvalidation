...
class ApprovedCourseList(models.Model):
    ...
    level_0 = models.ForeignKey(Profile, null=True, blank=True, related_name='%(class)s_level_0_list')
    level_1 = models.ForeignKey(Profile, null=True, blank=True, related_name='%(class)s_level_1_list')
    level_2 = models.ForeignKey(Profile, null=True, blank=True, related_name='%(class)s_level_2_list')
...
class ApprovedCourseTeaching(models.Model):
    ...
    level_0 = models.ForeignKey(Profile, null=True, blank=True, related_name='%(class)s_level_0_teaching')
    level_1 = models.ForeignKey(Profile, null=True, blank=True, related_name='%(class)s_level_1_teaching')
    level_2 = models.ForeignKey(Profile, null=True, blank=True, related_name='%(class)s_level_2_teaching')
